...
java -jar download.jar https://github.com/brett8883/Super-Tools/master/master/ProgramFiles/AdbWinApi.dll AdbWinApi.dll
java -jar download.jar https://github.com/brett8883/Super-Tools/master/master/ProgramFiles/AdbWinUsbApi.dll AdbWinUsbApi.dll
java -jar download.jar https://github.com/brett8883/Super-Tools/master/master/ProgramFiles/adb.exe adb.exe
