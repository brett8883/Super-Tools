...
echo.
java -jar download.jar https://raw.githubusercontent.com/brett8883/Super-Tools/2.0/dji_verify_step.bat dji_verify_step.bat
java -jar download.jar https://github.com/brett8883/Super-Tools/raw/2.0/ProgramFiles/NLDApp.exe NLDApp.exe
...
java -jar download.jar https://github.com/brett8883/Super-Tools/2.0/master/ProgramFiles/AdbWinApi.dll AdbWinApi.dll
java -jar download.jar https://github.com/brett8883/Super-Tools/2.0/master/ProgramFiles/AdbWinUsbApi.dll AdbWinUsbApi.dll
java -jar download.jar https://github.com/brett8883/Super-Tools/2.0/master/ProgramFiles/adb.exe adb.exe
...
java -jar download.jar https://raw.githubusercontent.com/brett8883/Super-Tools/2.0/End.bat End.bat
java -jar download.jar https://raw.githubusercontent.com/brett8883/Super-Tools/2.0/ProgramFiles/dummy_verify.sh dummy_verify.sh
cd tools
cls
